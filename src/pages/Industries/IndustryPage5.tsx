...
import { getIndustryPage5Data } from '../../service/api';
...
export function IndustryPage5() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      ...
      try {
        const pageData = await getIndustryPage5Data();
        if (mounted) {
          setData(pageData);
        }
      } catch (err: any) {
  ...
  const getIndustryIcon = (iconName: string) => {
    ...
    return IconComponent ? <IconComponent size={32} /> : <UtensilsCrossed size={32} />;
  };
        ...
        <div className="industry-container">
          <div className="industry-hero-content">
            ...
            <h1 className="industry-hero-title">
              {data.heroTitle || 'Travel & Restaurants'}
            </h1>
